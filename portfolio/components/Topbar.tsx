...
export default function Topbar() {
  ...
  return (
    <div className="w-full max-w-xl bg-gray-50 rounded-lg relative" ref={menuRef}>
      ...
      {/* Dropdown Menu */}
      <div className={`absolute top-full left-0 right-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-lg z-50 transition-all duration-300 ease-in-out transform ${
        isMenuOpen 
